...
import (
	context "context"
	api "github.com/micro/go-micro"
	client "github.com/micro/go-micro"
...
type PodService interface {
	...
	DelPod(ctx context.Context, in *PodId, opts ...client.CallOption) (*Response, error)
	...
	FindAllPod(ctx context.Context, in *FindAll, opts ...client.CallOption) (*PodList, error)
}
...
func (c *podService) DelPod(ctx context.Context, in *PodId, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Pod.DelPod", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *podService) FindAllPod(ctx context.Context, in *FindAll, opts ...client.CallOption) (*PodList, error) {
...
func (h *podHandler) DelPod(ctx context.Context, in *PodId, out *Response) error {
	return h.PodHandler.DelPod(ctx, in, out)
}
...
func (h *podHandler) FindAllPod(ctx context.Context, in *FindAll, out *PodList) error {
